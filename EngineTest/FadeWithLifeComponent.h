...
struct FadeWithLifeComponent : public MistThread::Core::GameObjects::Components::Component
{
  //Constructors
  /// <summary>
  ...
  FadeWithLifeComponent(MistThread::Core::GameObjects::GameObjectBase* owner);
  /// <summary>
  /// Default destructor for the component.
  /// </summary>
  ~FadeWithLifeComponent() { }
...
private:
  ParticleDataComponent *pParticleData_;                                        //Pointer to the particle data.
