  ...
  namespace IO
  {
    namespace XML
    {
      ...
      public:
        ...
        /// <exception cref="std::exception">thrown when the attribute can't be found</exception>
        XMLAttribute &GetAttributeByName(std::string name);
        /// <summary>
        /// returns all elements with the given name
        /// </summary>
        /// <param name="name">the name of the elements to find</param>
        std::vector<XMLElement*> GetElementsByName(std::string name);
        /// <summary>
        /// returns all attributes with the given name
        /// </summary>
        /// <param name="name">the name of the attributes to find</param>
        std::vector<XMLAttribute*> GetAttributesByName(std::string name);
        /// <summary>
        ...
        XMLAttribute &AddAttribute(std::string name, std::string value = "");
        /// <summary>
